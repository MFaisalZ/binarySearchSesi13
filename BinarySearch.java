...
public class Kamus {
    ...
    public static void main(String[] args) {
        ...
        indoToEng.put("kelas", "class");
        indoToEng.put("murid", "student");
        indoToEng.put("guru", "teacher");
        indoToEng.put("buku", "book");
        indoToEng.put("perpustakaan", "library");
